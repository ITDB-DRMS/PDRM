                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 space-y-8 text-center lg:text-left">
                            ...
                            <motion.p
                                ...
                                className="text-lg text-slate-300 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium"
                            >
                                Help us perfect the IDRMIS ecosystem. Your feedback directly influences the tools we build for national resilience.
                            </motion.p>
