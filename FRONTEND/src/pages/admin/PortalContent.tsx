...
type PortalContent = {
  ...
  header?: { navLinks?: { label: string; href: string }[]; ctaLabel?: string; ctaHref?: string };
  sectionsVisibility?: {
    header?: boolean;
    hero?: boolean;
    about?: boolean;
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setContent((c) => ({
                  ...c,
                  featuresSection: { ...(c.featuresSection || {}), subheading: e.target.value, features },
                }))
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setContent((c) => ({
                  ...c,
                  servicesSection: { ...(c.servicesSection || {}), subheading: e.target.value, services },
                }))
              }
            />
          </div>
            ...
            <input
              ...
              onChange={(e) =>
                setContent((c) => ({
                  ...
                  pages: {
                    ...(c.pages || {}),
                    feedback: { ...(c.pages?.feedback || {}), subtitle: e.target.value },
                  },
                }))
              }
            />
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          {(content.header?.navLinks || []).map((l, idx) => (
            <div key={idx} className="grid grid-cols-1 md:grid-cols-3 gap-4 rounded-2xl border border-slate-100 p-4">
              <div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setContent((c) => ({ ...c, footer: { ...(c.footer || {}), blurb: e.target.value } }))}
          />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-2">
        ...
        <div className="space-y-3">
          ...
          {(content.footer?.quickLinks || []).map((l, idx) => (
            <div key={idx} className="grid grid-cols-1 md:grid-cols-4 gap-4 rounded-2xl border border-slate-100 p-4">
              <div>
                <label className="text-xs font-bold text-slate-600">Label</label>
                <input
                  className={inputClass}
