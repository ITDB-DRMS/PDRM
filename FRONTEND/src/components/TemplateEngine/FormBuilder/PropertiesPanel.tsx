    ...
    return (
        <div className="w-80 border-l bg-white h-full overflow-y-auto p-6 space-y-8">
            ...
            <div className="space-y-4">
                ...
                {(field.type !== 'note' && field.type !== 'header') && (
                    <div>
                ...
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase mb-1">
                        {(field.type === 'note' || field.type === 'header') ? 'Text Content' : 'Question Label'}
                    </label>
                    <textarea
                        value={field.label}
                                ...
                                <div className="space-y-3">
                                    ...
                                    {field.matrixConfig?.columns?.map((col: any, idx: number) => (
                                        <div key={idx} className="flex gap-2">
                                            ...
                                            />
                                            <button onClick={() => {
                                                const newCols = field.matrixConfig.columns.filter((_: any, i: number) => i !== idx);
                                                handleUpdate({ matrixConfig: { ...field.matrixConfig, columns: newCols } });
